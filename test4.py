...
# --- Load Models ---
model_best = keras.models.load_model(r"E:\emotion\Multi Modal Emotion Aware Assistant\Multi Modal Emotion Aware Assistant\models\face_emotion.h5")
audio_model = keras.models.load_model(r"E:\emotion\Multi Modal Emotion Aware Assistant\Multi Modal Emotion Aware Assistant\models\audio_emotion.keras")
...
start = st.button("▶️ Start Conversation")
...
while st.session_state.running:
    ...
    if ret:
        ...
        st.warning("Couldn't access webcam frame.")
        break
